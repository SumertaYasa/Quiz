<template>
    <div class="bg-white">
        ...
        <div class="mx-auto max-w-7xl mobile-menu">
          ...
          >
            <div class="flex-grow p-4 space-y-4">
              <a
                href="#"
                class="block py-2 text-center text-gray-800 rounded-md hover:bg-gray-100"
                >Beranda</a
              >
              <a
                href="#"
              ...
              <a
                href="#"
                class="block py-2 text-center text-white transition duration-200 bg-blue-600 rounded-md hover:bg-blue-700"
                >Masuk</a
              >
            </div>
          </div>
      ...
      <main
        class="pb-32 text-white text-center lg:text-left bg-[#3434bf] lg:pt-8"
      >
          ...
          <div class="flex flex-col lg:flex-row lg:items-center">
            <div class="lg:w-1/2 lg:pr-16">
              <h1 class="mb-4 text-4xl font-bold leading-tight lg:text-5xl">
                ...
                <span class="text-blue-400">PNBQuiz</span>
              </h1>
              ...
              <div class="flex justify-center mb-8 space-x-4 lg:justify-normal">
                <a
                  href="#"
                  class="px-6 py-3 text-center text-white transition duration-300 bg-blue-600 rounded-md hover:bg-blue-700"
                >
                ...
                <a
                  href="#"
                  class="px-6 py-3 text-center text-blue-700 transition duration-300 bg-gray-200 rounded-md hover:bg-gray-300"
                >
            ...
            <div class="mt-12 lg:w-1/2 lg:mt-0">
              <div class="flex items-center justify-center h-60 lg:h-96">
                <img
                  ...
                  id="idleImage"
                  alt="Logo PNB"
                  class="object-contain max-w-full max-h-full rounded-lg drop-shadow-lg"
                />
              </div>
            </div>
          </div>
            ...
            <div class="flex flex-wrap items-center justify-between -mx-4">
              <div class="w-full px-4 pb-1 sm:w-1/3 sm:mb-0">
                <div class="flex items-center">
                  ...
                  <div>
                    <h3 class="text-xl font-bold">10+ Kuis</h3>
                    <p class="text-sm">
                      Memiliki lebih dari 32 dosen yang ahli dibidang teknologi
                      informasi
                    </p>
                  </div>
                </div>
              ...
              <div class="w-full px-4 mb-6 sm:w-1/3 sm:mb-0">
                <div class="flex items-center">
                  ...
                  <div>
                    <h3 class="text-xl font-bold">100+ Mahasiswa Terdaftar</h3>
                    <p class="text-sm">
                      Memiliki 3 program studi yang sesuai dengan teknologi
                      informasi
                    </p>
                  </div>
                </div>
              ...
              <div class="w-full px-4 sm:w-1/3">
                <div class="flex items-center">
                  ...
                  <div>
                    <h3 class="text-xl font-bold">20+ Dosen Terdaftar</h3>
                    <p class="text-sm">
                      Memiliki 300 lebih alumni yang kompeten dibidangnya
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section class="px-6 bg-white lg-lite:py-20">
        <div
          class="flex flex-col items-center justify-center w-full max-w-4xl p-6 mx-auto"
        >
          <h2 class="relative inline-block pb-3 mb-8 text-5xl font-bold">
            Panduan singkat
            <span
              class="absolute bottom-0 left-0 w-full h-2 transform bg-gradient-to-r from-blue-400 to-blue-600 -skew-y-1"
            ></span>
          </h2>
          <div class="flex justify-center pt-2 mb-8 space-x-4">
            <button
              id="btn-mendapatkan-akun"
              class="px-6 py-3 font-semibold text-white transition duration-300 ease-in-out bg-blue-500 rounded-lg shadow-md hover:bg-blue-600"
            >
              MENDAPATKAN AKUN
            </button>
            <button
              id="btn-masuk-sistem"
              class="px-6 py-3 font-semibold text-gray-500 transition duration-300 ease-in-out bg-gray-200 rounded-lg shadow-md hover:bg-gray-300"
            >
              MASUK SISTEM
            </button>
            <button
      ...
      <section class="px-6 py-16 bg-blue-600">
        <div class="max-w-4xl mx-auto text-center">
          <h2 class="mb-6 text-3xl font-bold text-white">
            Siap untuk Meningkatkan Pengetahuanmu?
          </h2>
          <p class="mb-8 text-xl text-blue-100">
            Bergabunglah dengan ribuan mahasiswa PNB yang telah merasakan manfaat
            belajar interaktif melalui PNB Quiz!
          </p>
          <a
            href="#"
            class="px-8 py-3 text-lg font-semibold text-blue-600 transition duration-300 bg-white rounded-md hover:bg-blue-50"
            >Daftar Sekarang</a
          >
        </div>
      </section>
      ...
      <footer class="px-6 py-8 text-white bg-gray-800">
        <div class="flex flex-wrap justify-between mx-auto max-w-7xl">
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            ...
            <p class="text-gray-400">
              Platform quiz interaktif untuk mahasiswa Politeknik Negeri Bali.
            </p>
          </div>
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            ...
            <ul class="space-y-2">
              ...
              <li>
                <a href="#" class="text-gray-400 hover:text-white">Leaderboard</a>
              </li>
              <li>
          ...
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            ...
            <ul class="space-y-2">
              ...
              <li class="text-gray-400">
                Alamat: Jalan Raya Uluwatu No. 45, Jimbaran, Bali
              </li>
            </ul>
          </div>
        ...
        <div
          class="pt-8 mx-auto mt-8 text-center text-gray-400 border-t border-gray-700 max-w-7xl"
        >
